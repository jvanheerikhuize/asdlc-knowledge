...
Nodes colored by confidence band. Use the **2D / 3D** toggle to switch between the Mermaid diagram and an interactive force-directed graph (drag to rotate, scroll to zoom, click a node to focus). Regenerate with `python tools/kb.py viz`.
